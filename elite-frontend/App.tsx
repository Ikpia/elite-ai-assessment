...
import { SpinningGlobeScene } from './components/QuantumScene';
import {
  AlertCircle,
  ArrowDown,
  ArrowRight,
...
const MARKETING_SITE_URL = (import.meta.env.VITE_MARKETING_SITE_URL || 'https://eliteglobalai.com').replace(/\/$/, '');
      ...
      <header className="relative min-h-screen overflow-hidden pt-24 md:pt-28">
        ...
        <div className="relative z-10 mx-auto max-w-[min(98vw,1500px)] px-4 pb-12 sm:px-6 lg:px-8">
          <div className="grid min-h-[calc(100vh-8rem)] items-center gap-10 lg:grid-cols-[1fr_1fr] lg:gap-8">
            <div className="flex max-w-[46rem] flex-col items-center justify-center text-center lg:mx-auto lg:items-center lg:text-center">
              <h1 className="font-serif text-5xl font-medium leading-tight text-stone-900 drop-shadow-sm md:text-7xl lg:text-[5.8rem] lg:leading-[0.9]">
                Elite Global AI <br/><span className="mt-4 block text-3xl font-normal italic text-stone-600 md:text-5xl">AI Readiness Assessment Platform</span>
              </h1>
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <button onClick={() => navigate('/start')} className="rounded-full bg-stone-900 px-6 py-3 text-white shadow-lg transition-colors hover:bg-stone-800">
                  Begin Assessment
                </button>
              </div>

              <div className="mt-12 flex justify-center">
                <a href="#introduction" onClick={goToSection('introduction')} className="group flex flex-col items-center gap-2 text-sm font-medium text-stone-500 transition-colors hover:text-stone-900 cursor-pointer">
                  <span>DISCOVER</span>
                  <span className="rounded-full border border-stone-300 bg-white/50 p-2 transition-colors group-hover:border-stone-900">
                    <ArrowDown size={16} />
                  </span>
                </a>
              </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-stone-600 leading-relaxed">
                Directors need more than a raw score. The reporting layer frames results against benchmark ranges so leadership can understand whether the organisation is AI unaware, exploring, developing, or proficient.
              </p>
            </div>
  ...
  const renderStart = () => (
    <div className="relative min-h-screen overflow-hidden bg-[#F9F8F4] pt-20 pb-8">
      ...
      <div className="relative mx-auto max-w-[min(98vw,1500px)] px-2 pt-2 pb-4 sm:px-4 lg:px-6">
            <section className="mb-4 rounded-[28px] border border-stone-200 bg-white/90 px-5 pt-4 pb-5 shadow-lg backdrop-blur-sm sm:px-6 sm:pt-5 sm:pb-6">
              <div className="grid gap-4 lg:grid-cols-[1.2fr_0.85fr] lg:items-start">
                ...
                <div className="grid content-start gap-3 sm:grid-cols-3 lg:grid-cols-1 lg:pl-2">
              ...
              <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px] xl:grid-cols-[minmax(0,1fr)_400px]">
                <div>
                  ...
                  <div className="mb-5 space-y-2">
                    <h2 className="font-serif text-[1.42rem] font-medium leading-[1.08] tracking-[0.01em] text-slate-950 sm:text-[1.68rem]">Welcome</h2>
                    <p className="max-w-2xl text-[0.98rem] leading-7 tracking-[0.01em] text-slate-500 sm:text-[1.04rem]">
                      Provide the respondent information below before starting the
                      assessment. Select the firm type first so the correct
                      questionnaire is loaded for your organisation.
                    </p>
                  </div>

                  <form className="grid gap-4 md:grid-cols-2" onSubmit={(event) => { void handleStartAssessment(event); }}>
                <div className="space-y-2.5">
                  <label className="ml-1 text-[12px] font-extrabold uppercase tracking-[0.22em] text-slate-400">Type of Firm</label>
                  <select
                    className="w-full rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 text-[15px] font-medium text-slate-900 outline-none transition focus:border-nobel-gold focus:bg-white"
                ...
                <div className="space-y-2.5">
                  <label className="ml-1 text-[12px] font-extrabold uppercase tracking-[0.22em] text-slate-400">Email Address</label>
                  <input
                    type="email"
                ...
                <div className="space-y-2.5">
                  <label className="ml-1 text-[12px] font-extrabold uppercase tracking-[0.22em] text-slate-400">Full Name</label>
                  <input
                    type="text"
                ...
                <div className="space-y-2.5">
                  <label className="ml-1 text-[12px] font-extrabold uppercase tracking-[0.22em] text-slate-400">Organisation Name</label>
                  <input
                    type="text"
                    placeholder="GTBank"
                    className="w-full rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 text-[15px] font-medium text-slate-900 outline-none transition focus:border-nobel-gold focus:bg-white"
                ...
                <div className="space-y-2.5">
                  <label className="ml-1 text-[12px] font-extrabold uppercase tracking-[0.22em] text-slate-400">Role Level</label>
                  <select
                    className="w-full rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 text-[15px] font-medium text-slate-900 outline-none transition focus:border-nobel-gold focus:bg-white"
                    value={formData.role}
                ...
                <div className="space-y-2.5">
                  <label className="ml-1 text-[12px] font-extrabold uppercase tracking-[0.22em] text-slate-400">Department</label>
                  <input
                    type="text"
                    placeholder="Finance"
                    className="w-full rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 text-[15px] font-medium text-slate-900 outline-none transition focus:border-nobel-gold focus:bg-white"
                ...
                <div className="md:col-span-2 flex gap-3">
                  <button
                    ...
                    className="flex flex-1 items-center justify-center gap-3 rounded-full bg-blue-900 px-6 py-3 text-[16px] font-bold text-white transition hover:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-70"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => navigate('/')}
                    className="rounded-full border border-stone-200 px-5 py-3 text-[16px] font-semibold text-stone-700 transition hover:border-stone-300 hover:bg-stone-50"
                  >
                    Home
                  </button>
                </div>
      ...
      <div className="relative min-h-screen overflow-hidden bg-[#F4F7FC] pt-20 pb-4">
        ...
        <div ref={assessmentViewportRef} className="relative mx-auto max-w-[min(98vw,1500px)] overflow-hidden px-2 pb-4 sm:px-4 lg:px-6">
          <div style={{ height: assessmentScaledHeight ? `${assessmentScaledHeight}px` : undefined }}>
            ...
            >
              <section className="mb-4 rounded-[24px] border border-blue-100 bg-white/95 p-4 shadow-[0_16px_40px_rgba(15,23,42,0.05)] backdrop-blur-sm sm:p-5">
                      ...
                      return (
                        ...
                        >
                          <div className="flex h-full items-start gap-3">
                            <div className={`mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border text-xs font-extrabold ${selected ? 'border-blue-600 bg-blue-600 text-white' : 'border-stone-200 bg-slate-50 text-slate-500 group-hover:border-blue-200 group-hover:text-blue-700'}`}>
                              {optionMarker}
                            </div>
        ...
        <div className="rounded-[36px] border border-stone-200 bg-white p-8 text-center shadow-xl sm:p-12">
          ...
          <div className="flex flex-col justify-center gap-3 sm:flex-row">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-blue-900 px-6 py-3 text-sm font-bold text-white transition hover:bg-blue-800"
            >
            ...
            <section className="rounded-[28px] border border-stone-200 bg-white p-5 shadow-xl sm:p-6">
              <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px] xl:grid-cols-[minmax(0,1fr)_400px]">
                <div>
                  ...
                  <div className="mb-5 space-y-2">
                    <h2 className="font-serif text-[1.42rem] font-medium leading-[1.08] tracking-[0.01em] text-slate-950 sm:text-[1.68rem]">
                      Admin Login
                    </h2>
                    <p className="max-w-2xl text-[0.98rem] leading-7 tracking-[0.01em] text-slate-500 sm:text-[1.04rem]">
                  ...
                  <div className="space-y-5">
                    <div className="space-y-2.5">
                      <label className="ml-1 text-[12px] font-extrabold uppercase tracking-[0.22em] text-slate-400">Secure Access Token</label>
                      <input
                        type="password"
                        placeholder="••••••••••••"
                        className="w-full rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 font-mono text-[15px] font-medium text-slate-900 outline-none transition focus:border-nobel-gold focus:bg-white"
                        value={secretInput}
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-3 rounded-full bg-blue-900 px-6 py-3 text-[15px] font-bold text-white transition hover:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-70"
                    >
                ...
                <aside className="space-y-4">
                  ...
                  <div className="rounded-[24px] border border-stone-200 bg-stone-50 p-6">
                    <p className="mb-3 text-[15px] font-bold text-slate-900">Before you send</p>
                    <p className="text-[14px] leading-6 text-slate-700">
          ...
          <div className="mb-4 rounded-[28px] border border-stone-200 bg-white/95 p-5 shadow-xl sm:p-6">
            <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <h1 className="font-serif text-[1.62rem] font-medium leading-[1.04] tracking-[0.01em] text-slate-950 sm:text-[1.96rem] lg:text-[2.42rem]">Organisation readiness overview</h1>
              </div>

              <div className="flex flex-wrap gap-3">
                <button
                  onClick={() => { void fetchOrgs(secret); }}
                  className="inline-flex items-center gap-2 rounded-full border border-stone-200 px-5 py-3 text-[15px] font-semibold text-stone-700 transition hover:border-stone-300 hover:bg-stone-50"
                >
                  Refresh
                </button>
                <button
                  onClick={handleLogout}
                  className="inline-flex items-center gap-2 rounded-full bg-stone-900 px-5 py-3 text-[15px] font-semibold text-white transition hover:bg-stone-800"
                >
                ...
                return (
                  <div key={organisation.id} className="rounded-[28px] border border-stone-200 bg-white p-5 shadow-xl sm:p-6">
                    <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                      <div>
                        <div className="mb-3 flex flex-wrap items-center gap-3">
                          <h2 className="font-serif text-[1.4rem] font-medium tracking-[0.01em] text-slate-950 sm:text-[1.6rem]">{organisation.orgName}</h2>
                        ...
                        <p className="mt-2 text-[14px] text-stone-500">Readiness band: {getReadinessLabel(organisation.aggregatedScores.total)}</p>
                      </div>

                      <div className="rounded-[24px] border border-stone-200 bg-stone-50 px-5 py-4 text-right">
                        <p className="mb-2 text-[9px] font-extrabold uppercase tracking-[0.2em] text-slate-400">Responses</p>
                        <p className="font-serif text-[1.7rem] font-medium text-slate-950">{organisation.submissionCount}</p>
                        {completionRatio !== null ? (
                          <p className="text-[14px] text-stone-500">{completionRatio.toFixed(0)}% of expected</p>
                        ) : null}
                      </div>
                    </div>
                    ...
                    <div className="grid gap-5 lg:grid-cols-3">
                      ...
                      <div className="space-y-2.5">
                        <label className="ml-1 text-[12px] font-extrabold uppercase tracking-[0.22em] text-slate-400">Director Email</label>
                        <input
                          type="email"
                          className="w-full rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 text-[15px] font-medium text-slate-900 outline-none transition focus:border-nobel-gold focus:bg-white"
                      ...
                      <div className="space-y-2.5">
                        <label className="ml-1 text-[12px] font-extrabold uppercase tracking-[0.22em] text-slate-400">Expected Respondents</label>
                        <input
                          type="number"
                          min="1"
                          className="w-full rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 text-[15px] font-medium text-slate-900 outline-none transition focus:border-nobel-gold focus:bg-white"
                    ...
                    <div className="mt-6 flex flex-wrap gap-3">
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-full border border-stone-200 px-5 py-3 text-[15px] font-semibold text-stone-700 transition hover:border-stone-300 hover:bg-stone-50 disabled:cursor-not-allowed disabled:opacity-70"
                      >
                      ...
                      <button
                        ...
                        disabled={Boolean(busyKey)}
                        className="inline-flex items-center gap-2 rounded-full bg-stone-900 px-5 py-3 text-[15px] font-semibold text-white transition hover:bg-stone-800 disabled:cursor-not-allowed disabled:opacity-70"
                      >
            ...
            <div className="grid gap-10 lg:grid-cols-[1.2fr_0.75fr_0.95fr]">
              <div className="space-y-5">
                ...
                <p className="max-w-xl text-sm leading-7 text-slate-400">
                  ...
                  healthcare, consulting firms, and SMEs, with executive-grade
                  reporting and clear commercial follow-through.
                </p>
                <a
                  href={MARKETING_SITE_URL}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border border-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:border-slate-500 hover:bg-slate-800"
                >
                  Visit Website
                  <ArrowRight className="h-4 w-4" />
                </a>
                ...
                <div className="flex flex-wrap gap-3">
                  {FOOTER_SOCIALS.map(({ label, href, icon: Icon }) => (
                    <a
                      ...
                      rel="noreferrer"
                      aria-label={label}
                      className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-700 bg-slate-900 text-slate-300 transition hover:border-blue-400 hover:text-white"
                    >
